...
(1, 'Dịch vụ trông giữ chó mèo'),
(2, 'Chăm sóc thú cưng'),
(3, 'Cứu hộ thú cưng'),
(4, 'Spa cho thú cưng'),
(5, 'Dịch vụ tắm cho chó mèo'),
(6, 'Dịch vụ cắt tỉa lông chó mèo');
...
CREATE TABLE `tbl_service_register` (
  ...
  `ser_email` varchar(10) NOT NULL,
  `ser_time` date NOT NULL,
  `ser_sdt` varchar(11) NOT NULL,
...
INSERT INTO `tbl_service_register` (`ser_id`, `service_id`, `user_id`, `ser_name`, `ser_email`, `ser_time`, `ser_sdt`, `ser_diachi`) VALUES
